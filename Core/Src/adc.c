...
void MX_ADC3_Init(void) {
	...
	hadc3.Init.Oversampling.OversamplingStopReset =
			ADC_REGOVERSAMPLING_CONTINUED_MODE;
...
void HAL_ADC_MspInit(ADC_HandleTypeDef *adcHandle) {
	...
	if (adcHandle->Instance == ADC1) {
		...
		/**ADC1 GPIO Configuration
		 ...
		 PC4     ------> ADC1_INP4
		 */
		GPIO_InitStruct.Pin = PWR_ADC_BAT_Pin | MTR_ADC_SOA_R_Pin;
		GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
		GPIO_InitStruct.Pull = GPIO_NOPULL;
		HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

		GPIO_InitStruct.Pin = MTR_ADC_SOC_R_Pin;
		GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
		GPIO_InitStruct.Pull = GPIO_NOPULL;
		HAL_GPIO_Init(MTR_ADC_SOC_R_GPIO_Port, &GPIO_InitStruct);
		...
		/**ADC2 GPIO Configuration
		 ...
		 PB1     ------> ADC2_INP5
		 */
		GPIO_InitStruct.Pin = PWR_ADC_BAT_Pin | MTR_ADC_SOC_L_Pin;
		GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
		GPIO_InitStruct.Pull = GPIO_NOPULL;
		HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

		GPIO_InitStruct.Pin = MTR_ADC_SOA_L_Pin;
		GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
		GPIO_InitStruct.Pull = GPIO_NOPULL;
		HAL_GPIO_Init(MTR_ADC_SOA_L_GPIO_Port, &GPIO_InitStruct);
		...
		/**ADC3 GPIO Configuration
		 ...
		 PC3_C     ------> ADC3_INP1
		 */
		GPIO_InitStruct.Pin = SENSOR_ADC_IR_IN_R_Pin;
		GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
		GPIO_InitStruct.Pull = GPIO_NOPULL;
		HAL_GPIO_Init(SENSOR_ADC_IR_IN_R_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef *adcHandle) {
	...
	if (adcHandle->Instance == ADC1) {
		...
		/**ADC1 GPIO Configuration
		 ...
		 PC4     ------> ADC1_INP4
		 */
		HAL_GPIO_DeInit(GPIOC, PWR_ADC_BAT_Pin | MTR_ADC_SOA_R_Pin);

		HAL_GPIO_DeInit(MTR_ADC_SOC_R_GPIO_Port, MTR_ADC_SOC_R_Pin);
		...
		/**ADC2 GPIO Configuration
		 ...
		 PB1     ------> ADC2_INP5
		 */
		HAL_GPIO_DeInit(GPIOC, PWR_ADC_BAT_Pin | MTR_ADC_SOC_L_Pin);

		HAL_GPIO_DeInit(MTR_ADC_SOA_L_GPIO_Port, MTR_ADC_SOA_L_Pin);
		...
		/**ADC3 GPIO Configuration
		 ...
		 PC3_C     ------> ADC3_INP1
		 */
		HAL_GPIO_DeInit(SENSOR_ADC_IR_IN_R_GPIO_Port, SENSOR_ADC_IR_IN_R_Pin);
